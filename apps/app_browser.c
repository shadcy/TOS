...
static const char *start_page_html =
    "<html><head><title>STAX Navigator // about:start</title></head><body>\n"
    "<pre>\n"
    "  ____ _____ _    __  __  _   _             _             _             \n"
    " / ___|_   _/ \\   \\ \\/ / | \\ | | __ ___   _(_) __ _  __ _| |_ ___  _ __ \n"
    " \\___ \\ | |/ _ \\   \\  /  |  \\| |/ _` \\ \\ / / |/ _` |/ _` | __/ _ \\| '__|\n"
    "  ___) || / ___ \\  /  \\  | |\\  | (_| |\\ V /| | (_| | (_| | || (_) | |   \n"
    " |____/ |_/_/   \\_\\/_/\\_\\ |_| \\_|\\__,_| \\_/ |_|\\__, |\\__,_|\\__\\___/|_|   \n"
    "                                               |___/                    \n"
    "  ======================================================================\n"
    "  STAX Graphical Web Browser  |  lwIP TCP/IP Stack  |  Terminal Edition \n"
    "  ======================================================================\n"
    "</pre>\n"
    "<h2>[Quick Navigation &amp; Search]</h2>\n"
    "<p>\n"
    " * <a href=\"http://wiby.me/\">[Wiby] - Classic Vintage Web Search Engine</a><br>\n"
    " * <a href=\"http://wiby.me/surprise/\">[Surprise] - Discover a Random Retro Website</a><br>\n"
    " * <a href=\"http://68k.news/\">[68k.news] - Minimalist Global News Wire</a><br>\n"
    " * <a href=\"http://httpforever.com/\">[HTTP Forever] - Pure HTTP Protocol Test</a><br>\n"
    " * <a href=\"http://example.com/\">[Example Domain] - IANA Standard RFC Test</a>\n"
    "</p>\n"
    "<hr>\n"
    "<h2>[Terminal Shortcuts &amp; Keys]</h2>\n"
    "<pre>\n"
    " [Enter URL]  Click URL bar or press [L] to focus\n"
    " [Navigate]   Type any domain or search query (e.g. wiby.me or tomato)\n"
    " [Scroll]     [W] / [S] or Arrow keys | [Space] Page Down\n"
    " [History]    [B] Back | [N] Forward | [R] Reload | [H] Home\n"
    "</pre>\n"
    "<hr>\n"
    "<h2>[System Architecture]</h2>\n"
    "<pre>\n"
    " Kernel Arch : STAX Preemptive Real-Time OS (ARM926EJ-S @ 1000Hz)\n"
    " Network     : SMC91C111 100Mbps Ethernet + lwIP TCP/IP Core\n"
    " HTML Engine : Native Zero-Heap Streaming DOM &amp; CSS Layout\n"
    "</pre>\n"
    "</body></html>";

static int is_about_url(const char *u) {
    return host_equals_i(u, "about:start") || host_equals_i(u, "about:home") ||
           host_equals_i(u, "about:") || host_equals_i(u, "about:about") ||
           host_equals_i(u, "about:credits") || host_equals_i(u, "about:blank") ||
           host_equals_i(u, "about:version") ||
